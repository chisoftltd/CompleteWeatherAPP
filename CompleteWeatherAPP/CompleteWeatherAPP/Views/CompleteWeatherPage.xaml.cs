...
namespace CompleteWeatherAPP.Views
{
    ...
    public partial class CompleteWeatherPage : ContentPage
    {
        public CompleteWeatherPage()
        {
            InitializeComponent();
            GetCoordinates();
        }

        private string Location { get; set; } = "Enugu";
        ...
        private async void GetBackground()
        {
            ...
            var result = await ApiCaller.Get(url, "563492ad6f9170000100000119a61a5afb944c44929f3f82d70dcf65");
